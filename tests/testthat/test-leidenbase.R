...
#
res <- leiden_find_partition( igraph, partition_type = 'CPMVertexPartition', seed = 123456 )
...
res <- leiden_find_partition( igraph, partition_type = 'ModularityVertexPartition', seed = 123456 )
...
res <- leiden_find_partition( igraph, partition_type = 'RBConfigurationVertexPartition', seed = 123456 )
...
res <- leiden_find_partition( igraph, partition_type = 'RBERVertexPartition', seed = 123456 )
...
res <- leiden_find_partition( igraph, partition_type = 'SignificanceVertexPartition', seed = 123456 )
...
res <- leiden_find_partition( igraph, partition_type = 'SurpriseVertexPartition', seed = 123456 )
...
res <- leiden_find_partition( igraph, partition_type = 'RBConfigurationVertexPartition', num_iter = 5, seed = 123456 )
test_that( 'num_iter',
{
...
res <- leiden_find_partition( igraph, partition_type = 'RBConfigurationVertexPartition', initial_membership = inimem, seed = 123456 )
test_that( 'RBConfigurationVertexPartition membership and quality',
{
  expect_true( all.equal( rbconfiguration_membership, res$membership ) )
  expect_true( all.equal( 52882.31, res$quality, tolerance = 1.0e-6 ) )
...
res <- leiden_find_partition( igraph, partition_type = 'RBConfigurationVertexPartition', edge_weights = edgwgt, seed = 123456 )
test_that( 'RBConfigurationVertexPartition membership and quality',
{
  expect_true( all.equal( rbconfiguration_membership, res$membership ) )
  expect_true( all.equal( 52882.31, res$quality, tolerance = 1.0e-6 ) )
...
res <- leiden_find_partition( igraph, partition_type = 'RBConfigurationVertexPartition', node_sizes = nodsiz, seed = 123456 )
test_that( 'RBConfigurationVertexPartition membership and quality',
{
  expect_true( all.equal( rbconfiguration_membership, res$membership ) )
  expect_true( all.equal( 52882.31, res$quality, tolerance = 1.0e-6 ) )
...
{
  expect_error( leiden_find_partition( igraph, initial_membership = inimem ) )
})

edgwgt <- as.double( rep( 1.0, 61630 ) )
test_that( 'edge_weights',
{
  expect_error( leiden_find_partition( igraph, edge_weights = edgwgt ) )
})

nodsiz <- inimem <- as.integer( seq( 1, 1400 ) )
test_that( 'node_sizes',
{
  expect_error( leiden_find_partition( igraph, node_sizes = nodsiz ) )
})
...
test_that( 'num_iter',
{
  expect_error( leiden_find_partition( igraph, num_iter = 0 ) )
})
