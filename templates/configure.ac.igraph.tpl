dnl
dnl This file is a lightly modified copy of the Gabor Csardi's
...
dnl
AC_INIT(igraph, 1.1.0, csardi.gabor@gmail.com)
dnl AC_CONFIG_SRCDIR(src/rinterface.c)
dnl edit AC_CONFIG_SRCDIR() to look for src/igraph_set.c when used in leidenbase
...
dnl disable the Makevars generator when running configure
dnl for the leidenbase distribution
