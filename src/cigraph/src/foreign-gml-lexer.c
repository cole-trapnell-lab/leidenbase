...
#define igraph_gml_yywrap(yyscanner) 1
...
#line 1 "src/cigraph/src/foreign-gml-lexer.l"
/* 
   IGraph library.
...
*/
#line 24 "src/cigraph/src/foreign-gml-lexer.l"
...
#line 78 "src/cigraph/src/foreign-gml-lexer.l"
...
YY_RULE_SETUP
#line 80 "src/cigraph/src/foreign-gml-lexer.l"
{ /* comments ignored */ }
	YY_BREAK
case 2:
/* rule 2 can match eol */
YY_RULE_SETUP
#line 82 "src/cigraph/src/foreign-gml-lexer.l"
{ return STRING; }
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 83 "src/cigraph/src/foreign-gml-lexer.l"
{ return NUM; }
	YY_BREAK
case 4:
YY_RULE_SETUP
#line 84 "src/cigraph/src/foreign-gml-lexer.l"
{ return KEYWORD; }
	YY_BREAK
case 5:
YY_RULE_SETUP
#line 85 "src/cigraph/src/foreign-gml-lexer.l"
{ return LISTOPEN; }
	YY_BREAK
case 6:
YY_RULE_SETUP
#line 86 "src/cigraph/src/foreign-gml-lexer.l"
{ return LISTCLOSE; }
	YY_BREAK
case 7:
/* rule 7 can match eol */
YY_RULE_SETUP
#line 87 "src/cigraph/src/foreign-gml-lexer.l"
{ }
	YY_BREAK
case 8:
/* rule 8 can match eol */
YY_RULE_SETUP
#line 88 "src/cigraph/src/foreign-gml-lexer.l"
{ /* other whitespace ignored */ }
	YY_BREAK
case YY_STATE_EOF(INITIAL):
#line 90 "src/cigraph/src/foreign-gml-lexer.l"
{ 
                          if (yyextra->eof) {
			    yyterminate();
			  } else {
...
case 9:
YY_RULE_SETUP
#line 98 "src/cigraph/src/foreign-gml-lexer.l"
{ return ERROR; }
	YY_BREAK
case 10:
YY_RULE_SETUP
#line 99 "src/cigraph/src/foreign-gml-lexer.l"
...
void igraph_gml_yyset_lineno (int  line_number , yyscan_t yyscanner)
{
    struct yyguts_t * yyg = (struct yyguts_t*)yyscanner;
        ...
        if (! YY_CURRENT_BUFFER )
           YY_FATAL_ERROR( "igraph_gml_yyset_lineno called with no buffer" );
...
void igraph_gml_yyset_column (int  column_no , yyscan_t yyscanner)
{
    struct yyguts_t * yyg = (struct yyguts_t*)yyscanner;
        ...
        if (! YY_CURRENT_BUFFER )
           YY_FATAL_ERROR( "igraph_gml_yyset_column called with no buffer" );
