...
case 1:
YY_RULE_SETUP
#line 81 "src/cigraph/src/foreign-lgl-lexer.l"
{ return HASH; }
	YY_BREAK
/* ------------------------------------------------whitespace------*/
case 2:
YY_RULE_SETUP
#line 84 "src/cigraph/src/foreign-lgl-lexer.l"
{ }
	YY_BREAK
/* ---------------------------------------------------newline------*/
case 3:
...
YY_RULE_SETUP
#line 87 "src/cigraph/src/foreign-lgl-lexer.l"
{ return NEWLINE; }
	YY_BREAK
/* ----------------------------------------------alphanumeric------*/
case 4:
YY_RULE_SETUP
#line 90 "src/cigraph/src/foreign-lgl-lexer.l"
{ return ALNUM; }
	YY_BREAK
case YY_STATE_EOF(INITIAL):
#line 92 "src/cigraph/src/foreign-lgl-lexer.l"
{ if (yyextra->eof) {
                       yyterminate();
                    } else {
                       yyextra->eof=1;
...
case 5:
YY_RULE_SETUP
#line 100 "src/cigraph/src/foreign-lgl-lexer.l"
{ return ERROR; }
	YY_BREAK
case 6:
YY_RULE_SETUP
#line 102 "src/cigraph/src/foreign-lgl-lexer.l"
