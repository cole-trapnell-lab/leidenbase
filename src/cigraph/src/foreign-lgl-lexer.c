...
#define igraph_lgl_yywrap(yyscanner) 1
...
#line 1 "src/cigraph/src/foreign-lgl-lexer.l"
/* 
   IGraph library.
...
*/
#line 24 "src/cigraph/src/foreign-lgl-lexer.l"
...
#line 77 "src/cigraph/src/foreign-lgl-lexer.l"
...
case 1:
YY_RULE_SETUP
#line 80 "src/cigraph/src/foreign-lgl-lexer.l"
{ return HASH; }
	YY_BREAK
/* ------------------------------------------------whitespace------*/
case 2:
YY_RULE_SETUP
#line 83 "src/cigraph/src/foreign-lgl-lexer.l"
{ }
	YY_BREAK
/* ---------------------------------------------------newline------*/
case 3:
...
YY_RULE_SETUP
#line 86 "src/cigraph/src/foreign-lgl-lexer.l"
{ return NEWLINE; }
	YY_BREAK
/* ----------------------------------------------alphanumeric------*/
case 4:
YY_RULE_SETUP
#line 89 "src/cigraph/src/foreign-lgl-lexer.l"
{ return ALNUM; }
	YY_BREAK
case YY_STATE_EOF(INITIAL):
#line 91 "src/cigraph/src/foreign-lgl-lexer.l"
{ if (yyextra->eof) {
                       yyterminate();
                    } else {
                       yyextra->eof=1;
...
case 5:
YY_RULE_SETUP
#line 99 "src/cigraph/src/foreign-lgl-lexer.l"
{ return ERROR; }
	YY_BREAK
case 6:
YY_RULE_SETUP
#line 101 "src/cigraph/src/foreign-lgl-lexer.l"
...
void igraph_lgl_yyset_lineno (int  line_number , yyscan_t yyscanner)
{
    struct yyguts_t * yyg = (struct yyguts_t*)yyscanner;
        ...
        if (! YY_CURRENT_BUFFER )
           YY_FATAL_ERROR( "igraph_lgl_yyset_lineno called with no buffer" );
...
void igraph_lgl_yyset_column (int  column_no , yyscan_t yyscanner)
{
    struct yyguts_t * yyg = (struct yyguts_t*)yyscanner;
        ...
        if (! YY_CURRENT_BUFFER )
           YY_FATAL_ERROR( "igraph_lgl_yyset_column called with no buffer" );
